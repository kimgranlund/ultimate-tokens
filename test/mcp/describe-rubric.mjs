...
for (const ex of EXEMPLARS) {
  ...
  ok(kit.$schema === "ultimate-tokens-brand-kit/3" && kit.palettes.length === 8, `${ex.id}: families feed generateKit() to a full 8-palette kit (proves the exemplar is a valid brief fragment, not just prose)`);
}
