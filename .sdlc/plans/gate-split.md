...
- [ ] U6b (M) figures of record, adapter, baseline, check script, shipping skill · builder-l3 · reviewer-l2 · verifier-l2 · also U6-9, the close-out step that re-points the baseline `ref` (owner ruling 2026-09-20) · also U6-10, the load under 5 rule (owner ruling 2026-09-20); TESTS reads 50 on this tree, by command
