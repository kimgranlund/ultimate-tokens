...
| Type voices | **11** — Display · Headline · Sub-heading · Title · Sub-title · Lead · Body · Code · Label · Kicker · Tiny, each a fixed 3-step SM/MD/LG ramp shared across every treatment | `src/engine/type.mjs` `make11` |
