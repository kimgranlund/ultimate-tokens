...
| records-refresh U2 the C31 shape: §8 Doc drift, rerun note, 18 controls rerun | #691 | S | 🔵 | 1 | builder | build-691-U2 (builder-l2; reviewer-l1, verifier-l1) | unit/rr-U2 off plan/records-refresh @ e8c24ac | .worktrees/rr-U2 | .sdlc/plans/records-refresh.md | builder runs §6 controls and the doc sweep, returns the handoff |
