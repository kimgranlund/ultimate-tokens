...
open per the "hold the bar" ruling's own precedent (revision 14) applied a second time, narrower, scoped now to exactly the two coupled-mode misses, not the whole table.
