    ...
    return h(
      ...
      h(
        ...
        h(
          ...
          // Inside Figma, applying variables directly is the point — primary action, to the LEFT of Download all.
          this.inFigma
            ? h(
                "button",
                {
          ...
          // (Config save/load lives in the config sub-bar above the code.)
        ),
      ),
    );
  }
