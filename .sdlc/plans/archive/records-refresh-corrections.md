...
Correction (2026-09-20, plan records-followup U10, #709): the defective spans rows N1 and N2 quote in their `As written` column now carry the `cited:` marker beside them. Rule: `.sdlc/adapter.md` §3, the cited-quote clause under the Verbatim-quote rule.
