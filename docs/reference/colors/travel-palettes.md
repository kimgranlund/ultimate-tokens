...
> System colors are computed in OKLCH: hue fixed to canonical red (28°) / yellow (88°) / green (150°), chroma scaled to the palette's accent register, lightness held for legibility. They are tuned to belong to each palette rather than imported off-the-shelf.
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.110 28` | `#A35248` |
| system-yellow | `0.760 0.100 88` | `#CCAE63` |
| system-green | `0.560 0.090 150` | `#4B8358` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.170 28` | `#BC382F` |
| system-yellow | `0.760 0.160 88` | `#DBA900` |
| system-green | `0.560 0.150 150` | `#0E8C41` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.130 28` | `#AC4A41` |
| system-yellow | `0.760 0.137 88` | `#D5AB37` |
| system-green | `0.560 0.120 150` | `#36884D` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.113 28` | `#A55147` |
| system-yellow | `0.760 0.119 88` | `#D1AC4F` |
| system-green | `0.560 0.104 150` | `#428553` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.112 28` | `#A45147` |
| system-yellow | `0.760 0.118 88` | `#D0AC51` |
| system-green | `0.560 0.103 150` | `#438553` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.138 28` | `#AF473D` |
| system-yellow | `0.760 0.145 88` | `#D7AB28` |
| system-green | `0.560 0.127 150` | `#30894A` |
...
|---|---|---|
| system-red | `0.535 0.110 28` | `#A35248` |
| system-yellow | `0.760 0.112 88` | `#CFAD57` |
| system-green | `0.560 0.098 150` | `#468555` |
...
|---|---|---|
| system-red | `0.535 0.110 28` | `#A35248` |
| system-yellow | `0.760 0.102 88` | `#CCAD61` |
| system-green | `0.560 0.090 150` | `#4B8358` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.145 28` | `#B2443A` |
| system-yellow | `0.760 0.152 88` | `#D9AA13` |
| system-green | `0.560 0.133 150` | `#2A8948` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.137 28` | `#AF483E` |
| system-yellow | `0.760 0.144 88` | `#D7AB2A` |
| system-green | `0.560 0.126 150` | `#31884B` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.133 28` | `#AD493F` |
| system-yellow | `0.760 0.140 88` | `#D6AB32` |
| system-green | `0.560 0.122 150` | `#34884C` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.135 28` | `#AE483F` |
| system-yellow | `0.760 0.142 88` | `#D7AB2E` |
| system-green | `0.560 0.124 150` | `#33884B` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.118 28` | `#A74F45` |
| system-yellow | `0.760 0.124 88` | `#D2AC49` |
| system-green | `0.560 0.109 150` | `#3F8651` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.150 28` | `#B44238` |
| system-yellow | `0.760 0.158 88` | `#DBA900` |
| system-green | `0.560 0.138 150` | `#248A46` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.125 28` | `#AA4C43` |
| system-yellow | `0.760 0.131 88` | `#D4AC40` |
| system-green | `0.560 0.115 150` | `#3A874F` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.131 28` | `#AC4A40` |
| system-yellow | `0.760 0.138 88` | `#D6AB35` |
| system-green | `0.560 0.121 150` | `#35884D` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.142 28` | `#B1453C` |
| system-yellow | `0.760 0.149 88` | `#D8AA1E` |
| system-green | `0.560 0.131 150` | `#2C8949` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.132 28` | `#AD4A40` |
| system-yellow | `0.760 0.139 88` | `#D6AB34` |
| system-green | `0.560 0.121 150` | `#35884D` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.120 28` | `#A84E44` |
| system-yellow | `0.760 0.126 88` | `#D2AC47` |
| system-green | `0.560 0.110 150` | `#3E8651` |
...
| Token | OKLCH | HEX |
|---|---|---|
| system-red | `0.535 0.127 28` | `#AA4C42` |
| system-yellow | `0.760 0.133 88` | `#D4AB3D` |
| system-green | `0.560 0.117 150` | `#39874E` |
