...
| Field | Value |
|---|---|
| Chosen | A: mirror T-0001 to a GitHub issue now (`adapter.py create --body-file .sdlc/plans/adopt-hygiene.md`), repoint board rows, keep `.sdlc/tickets/T-0001.md` as history |
