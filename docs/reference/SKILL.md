...
brand + 8 data — configurable per OD-005, DECIDED 2026-06-15); not a build-time pipeline (ADR-010); contrast-aware
on-colors are the DEFAULT resolution policy, not a non-goal (ADR-025, the ADR-003 amendment, closed OD-001);
no exposed VC controls (ADR-009);
