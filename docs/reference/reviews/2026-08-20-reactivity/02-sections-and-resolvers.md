...
Clamping mirror check: setters clamp type to [1,512] (typography.js:423) and geom to [8,256] (geometry.js:44, and the live-drag `_setGeomSize` at geometry.js:69); persist.js's `clampTokenOverrides` calls at persist.js:680 (`1, 512, 3`) and persist.js:798 (`8, 256, 2`) match exactly. No drift here.
