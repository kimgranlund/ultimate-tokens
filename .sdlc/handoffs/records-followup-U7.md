...
Correction (2026-09-20, plan records-followup U10, #709): the §Ran quotation of the runner's pass line was cut before the check mark the program prints. It now reads as the program prints it, taken from this unit's own `npm test` run. Rule: `.sdlc/adapter.md` §3, Verbatim-quote rule.
