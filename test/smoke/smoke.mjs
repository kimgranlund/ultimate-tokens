...
try {
  ...
  ok(await evalJS(`(()=>{const t=${el}.querySelector(".drawer-pre");return !!t && t.textContent.startsWith("/* Panda CSS preset, generated by Ultimate Tokens.")})()`), "Panda CSS export tab renders code starting with the header comment");
  ...
  ok(await evalJS(`(()=>{const t=${el}.querySelector(".drawer-pre");return !!t && t.textContent.startsWith("/* Park UI preset, generated by Ultimate Tokens.")})()`), "Park UI export tab renders code starting with the header comment");
