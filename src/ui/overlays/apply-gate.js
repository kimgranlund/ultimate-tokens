      ...
      h(
        ...
        h("p", { class: "apply-gate-lede" }, rebuild
          ...
          : (() => {
              ...
              const sys = this.exportSystems || {};
              const collections = sys.color === false
                ? "Type and Geometry variable collections"
                : "Color Primitives + Color Roles variable collections";
              return sys.styles === false
                ...
                : "This creates or updates the " + collections + " in this file, plus the STYLE swatches bound to them (paint styles per semantic role, text styles per type step — toggle \u201CStyles\u201D in the drawer to opt out). Variables and Ultimate Tokens styles with the same names are overwritten — which can re-skin components already bound to them (sometimes exactly what you want).";
            })()),
        h(
          "div",
