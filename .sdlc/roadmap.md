...
inputs: gh issue list --state open (14 issues), gh pr list --state open (1 PR), git worktree list, .sdlc/board.md, .sdlc/debt.md, plan/gate-split (#713, approved, local only), plan/preset-intent-fidelity (#681, local only), .sdlc/plans/records-followup.md, ticket #709
---
...
Count: P0 0 · P1 4 · P2 2 · P3 2 · unranked 6 (no priority label yet) · total 14.
