...
export class ApplyGateMixinImpl {
  ...
  applyToFigma(rebuild = false) {
    ...
    try {
      ...
      // destructive site it does NOT reach is applyFloatPlans' breakpoint-mode removeMode (#687), unguarded on
        ...
        h("p", { class: "apply-gate-lede" }, rebuild
          ...
          : (() => {
              ...
              const collectionParts = [
                sys.color !== false && "Color Primitives + Color Roles",
                (sys.type !== false || sys.geometry !== false) && "Geometry",
              ...
              const styleParts = [
                sys.color !== false && "paint styles per semantic role",
